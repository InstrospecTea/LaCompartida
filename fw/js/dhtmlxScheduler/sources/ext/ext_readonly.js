scheduler.attachEvent("onTemplatesReady",function(){
   ...
   scheduler._fill_lightbox=function(){
      ...
      if (this.config.readonly_active){
         ...
         txt_replace("input",d,n,function(a){ 
            return a.parentNode.innerHTML.replace(/<input/gi,"<input disabled='true'"); 
        });
         txt_replace("select",d,n,function(a){ return a.options[a.selectedIndex||0].text; });
