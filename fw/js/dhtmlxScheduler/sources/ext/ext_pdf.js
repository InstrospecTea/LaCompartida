scheduler.toPDF=function(url,mode,header,footer){ 
	...
	win.document.write('<form id="mycollformname" method="post"  accept-charset="utf-8" enctype="multipart/form-data"  action="'+url+'"><input type="hidden" name="mycoolxmlbody" id="mycoolxmlbody"/> </form>');
