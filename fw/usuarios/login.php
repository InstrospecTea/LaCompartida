<?php
  ...
  if($log != "")
  {
    ...
    list($rut,$dv_rut,$password,$url) = explode("&", $decoded);
    #saco los valores
    list($caca,$rut) = explode("=",$rut);
    list($caca,$dvrut) = explode("=",$dv_rut);
    list($caca,$password) = explode("=",$password);
		list($caca,$url) = explode("=",$url);
