...
* **Feature:** [Activaci�n de usuarios seg�n cupo](#468)
...
* **Fixed:** [Corrige opci�n compara hora cobrables](https://github.com/LemontechSA/ttb/pull/502)
...
* **Fixed:** [Corrige filtros en m�dulo de tareas](https://github.com/LemontechSA/ttb/pull/471)

## Hotfix: 14.1.10
Jueves 03 de abril 2014
* **Fixed:** [Cambia n�mero de nueva factura al selecionar serie.](https://github.com/LemontechSA/ttb/pull/470)

## Hotfix: 14.1.9
Mi�rcoles 2 de Abril 2014
* **Fixed:** [Corrige comportamientos para la migraci�n de Rebaza](https://github.com/LemontechSA/ttb/pull/469)
...
* **Fixed:** [Agrega traducci�n de asunto](https://github.com/LemontechSA/ttb/pull/461)
...
## Hotfix: 14.0.12
Mi�rcoles 12 de marzo 2014
* **Fixed:** [Corrige agrupador fecha de emisi�n en reporte avanzado.](https://github.com/LemontechSA/ttb/pull/440)
* **Fixed:** [Corrige el valor de los hitos en reporte horas por facturar.](https://github.com/LemontechSA/ttb/pull/440)
* **Fixed:** [Corrige moneda desplegada en listado de tr�mites.](https://github.com/LemontechSA/ttb/pull/440)
...
* **Fixed:** [Orden de datos de los gr�ficos](https://github.com/LemontechSA/ttb/pull/429)
...
## Hotfix: 14.0.3
Jueves 20 de febrero 2014
* **Added:** [Nuevos elementos para la facturaci�n del cliente "Governance"](https://github.com/LemontechSA/ttb/pull/420)
* **Added:** [Correcci�n a interfaz de gastos "Monto Facturable"](https://github.com/LemontechSA/ttb/pull/420)
...
* **Added:** [Agrega alerta para obligar a usuario a elegir un pa�s para evitar error en facturaci�n eletr�nica](https://github.com/LemontechSA/ttb/pull/412)
...
* **Fixed:** [Elimina query que reemplaza c�digo de asunto](https://github.com/LemontechSA/ttb/pull/408)
...
* **Fixed:** [Problemas con Nota de Cr�dito en SAT](https://github.com/LemontechSA/ttb/pull/396)
...
* **Fixed:** [Corregir correlativo de c�digos de actividades](https://github.com/LemontechSA/ttb/pull/362)
...
* **Added:** [Graficar horas no cobrables en reporte Reporte Gr�fico por Per�odo](https://github.com/LemontechSA/ttb/pull/358)
* **Fixed:** [Problemas con Facturaci�n Electr�nica M�xico](https://github.com/LemontechSA/ttb/pull/359)
...
* **Feature:** [Informe producci�n](https://github.com/LemontechSA/ttb/pull/310)
* **Fixed:** [Muestra �ltimo cobro del contrato](https://github.com/LemontechSA/ttb/pull/330)
...
## Hotfix: 13.6.18
Mi�rcoles 20 de Noviembre 2013
* **Fixed:** [Corrige el excel de gastos y soluci�n provisoria para backups de aym y bmaj](https://github.com/LemontechSA/ttb/pull/342)
...
* **Fixed:** [No permite que el campo para el rut del usuario esta vac�o](https://github.com/LemontechSA/ttb/pull/337)
...
* **Fixed:** [Permite generar facturas electr�nicas con diferente hora para que FacturemosYA no se caiga](https://github.com/LemontechSA/ttb/pull/336)
...
* **Fixed:** [Corrige bugs de encoding y glosa de r�gimen en facturaci�n electr�nica MX](https://github.com/LemontechSA/ttb/pull/333)
...
* **Added:** [Modificaciones a menu actividades, Modificaciones a tama�o de campos en agregar factura](https://github.com/LemontechSA/ttb/pull/327)
...
* **Fixed:** [Actualiza listado manteniendo orden y paginaci�n.](https://github.com/LemontechSA/ttb/pull/320)
...
* **Fixed:** [Error en JS al agregar un tr�mite en IE9](https://github.com/LemontechSA/ttb/pull/316)
* **Fixed:** [Corregir asignaci�n de cliente al crear factura](https://github.com/LemontechSA/ttb/pull/316)

## Hotfix: 13.6.2
Martes 15 de Octubre 2013

* **Fixed:** [Corregir edici�n campo duraci�n al agregar o modificar un tr�mite](https://github.com/LemontechSA/ttb/pull/314)
...
* **Feature:** [MultiCompa�ia](https://github.com/LemontechSA/ttb/pull/304)
* **Feature:** [Alerta nota de cr�dito](https://github.com/LemontechSA/ttb/pull/294)
...
* **Fixed:** [Corregir selecci�n de actividad al modificar trabajo](https://github.com/LemontechSA/ttb/pull/301)
...
* **Fixed:** [Corregir interfaz de b�squeda de adelantos](https://github.com/LemontechSA/ttb/pull/283)
...
* **Feature:** [Manejo de multiples compa�ias (estudios) para facturar](https://github.com/LemontechSA/ttb/pull/252)
...
* **Fixed:** [Corrige problema reporte resumen de liquidaciones con modalidad de c�lculo antigua](https://github.com/LemontechSA/ttb/pull/264)
...
* **Fixed:** [Correccion monto en palabra decimal para santiva�ez.](https://github.com/LemontechSA/ttb/pull/259)
...
* **Fixed:** [Generacion de nuevo tag para mantenedor pdf factura para cliente santiva�ez](https://github.com/LemontechSA/ttb/pull/256)

## Hotfix: 13.4.30
Viernes 02 de Agosto 2013
* **Fixed:** [Correcci�n reporte de saldo para que no duplique montos de gastos y provisiones](https://github.com/LemontechSA/ttb/pull/255)
...
* **Fixed:** [Corrige el reporte de saldo para incluir los adelantos del cliente (sin contrato espec�fico) y filtra el contrato correcto del gasto](https://github.com/LemontechSA/ttb/pull/249)
...
## Hotfix: 13.4.23
Jueves 25 de Julio 2013
* **Fixed:** [Corrige la asignaci�n de actividades (selector) al crear o modificar un trabajo](https://github.com/LemontechSA/ttb/pull/246)

## Hotfix: 13.4.22
Lunes 22 de Julio 2013
* **Fixed:** [Corrige c�lculo monto cobierto por adelanto seg�n moneda](https://github.com/LemontechSA/ttb/pull/243)
* **Fixed:** [Cargar los datos del cliente al agregar factura](https://github.com/LemontechSA/ttb/pull/243)

## Hotfix: 13.4.21
Viernes 19 de Julio 2013
* **Fixed:** [Corregir modificaci�n de cliente al editar una factura](https://github.com/LemontechSA/ttb/pull/242)

## Hotfix: 13.4.20
Viernes 19 de Julio 2013
* **Fixed:** [Se reemplaza el corrector ortogr�fico por pspell](https://github.com/LemontechSA/ttb/pull/241)
...
* **Fixed:** [Corrige fecha desde en secci�n Resumen Asuntos](https://github.com/LemontechSA/ttb/pull/235)
...
* **Fixed:** [Correcci�n carta Morales y Besa para retainers (forma anterior)](https://github.com/LemontechSA/ttb/pull/234)

## Hotfix: 13.4.14
Mi�rcoles 10 de Julio 2013
...
* **Fixed:** [Modificaci�n Nota de cobro para cumplir con requerimiento de Cuestacampos.](https://github.com/LemontechSA/ttb/pull/232)
...
* **Fixed:** [Correcci�n fecha �ltimo pago para facturas con SimpleReport y DataTables](https://github.com/LemontechSA/ttb/pull/231)

## Hotfix: 13.4.11
Lunes 1 de Julio 2013
* **Fixed:** [El autocompletador de datos de facturaci�n saca los datos del cliente y no del contrato](https://github.com/LemontechSA/ttb/pull/230)
* **Fixed:** [Visualizaci�n reportes de fecha con SimpleReport -> DataTables](https://github.com/LemontechSA/ttb/pull/230)
* **Fixed:** [Genera modificacion a seccion trabajos filas para operar con retainer](https://github.com/LemontechSA/ttb/pull/230)

## Hotfix: 13.4.10
Mi�rcoles 28 de Junio 2013
* **Fixed:** [Corrige calculo columnas retainer en seccion trabajos filas](https://github.com/LemontechSA/ttb/pull/224)

## Hotfix: 13.4.9
Mi�rcoles 26 de Junio 2013
* **Fixed:** [Corrige validaci�n Tipo de cambio](https://github.com/LemontechSA/ttb/pull/223)
* **Fixed:** [Env�o de alerta de correos avisando al administrador sobre correos no enviados](https://github.com/LemontechSA/ttb/pull/223)
...
* **Fixed:** [Corrige el env�o de correo mediante "cron_correo"](https://github.com/LemontechSA/ttb/pull/219)
* **Fixed:** [Corrige asignaci�n de c�digo cliente en WS de integraci�n de contabilidad](https://github.com/LemontechSA/ttb/pull/219)
...
* **Fixed:** [Correcci�n problema GlosaSeEstaCobrando al agregar factura o pago](https://github.com/LemontechSA/ttb/pull/215)

## Hotfix: 13.4.5
Jueves 20 de Junio 2013
* **Fixed:** [Correcci�n reporte saldo para mostrar honorarios y gastos sin saldo](https://github.com/LemontechSA/ttb/pull/213)

## Hotfix: 13.4.4
Jueves 20 de Junio 2013
* **Fixed:** [Correcci�n reporte horas por facturar considerando los descuentos](https://github.com/LemontechSA/ttb/pull/212)

## Hotfix: 13.4.3
Martes 18 de Junio 2013
* **Fixed:** [Cambio en forma de agrupaci�n de interfaz seguimiento cobro](https://github.com/LemontechSA/ttb/pull/211)
* **Fixed:** [Permite cambiar la glosa 'se est� cobrando' en cobros6.php](https://github.com/LemontechSA/ttb/pull/211)
...
* **Fixed:** [Agrega/recupera filtro (fecha facturaci�n) en reporte avanzados](https://github.com/LemontechSA/ttb/pull/209)
* **Fixed:** [Correcci�n a editar en (agregar_asunto.php) codigo secundario](https://github.com/LemontechSA/ttb/pull/209)
* **Fixed:** [Correcci�n del Conf 'SeEstaCobrandoEspecial' que s�lo ocupa BMAJ](https://github.com/LemontechSA/ttb/pull/209)
...
* **Fixed:** [Corrige m�todo QueriesPrevias (static) en ReporteContrato](https://github.com/LemontechSA/ttb/pull/209)
...
* **New:** [Revisi�n de logs de correos enviados](https://github.com/LemontechSA/ttb/pull/126)
...
* **Fixed:** [Mover los links de dichos reportes a la secci�n "varios" en reportes espec�ficos](https://github.com/LemontechSA/ttb/pull/146)
...
* **Fixed:** [Corrige c�lculo de filas en secci�n trabajo](https://github.com/LemontechSA/ttb/pull/197)
* **New:** [Nueva API para integrar las aplicaciones iPhone y Mac](https://github.com/LemontechSA/ttb/pull/207)

## hotfix: 13.3.30
Mi�rcoles 12 de Junio 2013
...
* **Fixed:** [Corrige tama�o popup editar horas. Permite modificar cliente en ambiente con codigo secundario. Conf MastacaraCodigoCliente  ](https://github.com/LemontechSA/ttb/pull/162)

## Hotfix: 13.3.10
jueves 11 de abril 2013
* **Fixed:** [Corrige la carta de cobro de gastos para VFC con c�lculo antig�o y nuevo m�dulo gastos](https://github.com/LemontechSA/ttb/pull/161)
...
* **Fixed:** [Corrige error en el m�todo WhereQuery de la clase Gasto, que se manifestaba al filtrar por asunto](https://github.com/LemontechSA/ttb/pull/142) [#pivotal](https://www.pivotaltracker.com/story/show/47089611)

## Hotfix: 13.3.2
Jueves 28 marzo 2013
* **Fixed:** [Corrige query de la interfaz trabajos. Ten�a un error sint�ctico que se manifiesta cuando se busca trabajos en la pantalla 2 del cobro](https://github.com/LemontechSA/ttb/pull/141) [#pivotal](https://www.pivotaltracker.com/story/show/47074217)
...
## Release: 13.3.0
Mi�rcoles 27 de marzo 2013.
* **New:** [Integraci�n contable de gastos](https://github.com/LemontechSA/ttb/pull/30)
* **New:** [Carga masiva de excel para implementaci�n](https://github.com/LemontechSA/ttb/pull/99)
* **Fixed:** [Guardar datos solicitante al agregar un cliente](https://github.com/LemontechSA/ttb/pull/107)
* **New:** [Integraci�n de nuevos m�todos para NotaCobro y CartaCobro](https://github.com/LemontechSA/ttb/pull/111)
* **New:** [Pantalla de configuraci�n labels para usabilidad](https://github.com/LemontechSA/ttb/pull/114)
...
## Hotfix: 13.2.12
* **Fixed:** [Sesion en may�sculas, clase TramiteTarifa](https://github.com/LemontechSA/ttb/pull/132)

## Hotfix: 13.2.11
* **Fixed:** [Correccion Tarifa proporcional](https://github.com/LemontechSA/ttb/pull/130)

## Hotfix: 13.2.10
* **Fixed:** [En vez de subir los backups a un bucket para cada cliente, usa el mismo bucket y luego un subdirectorio. Esto, porque Amazon tiene un l�mite de 100 buckets y ya lo pasamos](https://github.com/LemontechSA/ttb/pull/125)

## Hotfix: 13.2.9
* **Fixed:** [Correcci�n en validaci�n de fecha cuando usuarios de cobranza editan trabajos](https://github.com/LemontechSA/ttb/pull/117)
...
## Hotfix: 13.2.5
Martes 5 de marzo 2013.
* **Fixed:** [Filtra por c�digo asunto secundario](https://github.com/LemontechSA/ttb/pull/110)
...
* **New:** [Agrega tag de rut, ciudad, comuna y c�digo postal a la carta de cobro](https://github.com/LemontechSA/ttb/pull/106)
...
* **New:** [Validaci�n horas en trabajos diarios](https://github.com/LemontechSA/ttb/pull/71)
* **Fixed:** [Uso correcto de c�digo secundario en planilla de asuntos](https://github.com/LemontechSA/ttb/pull/75)
* **New:** [Nuevo c�lculo de deuda en base a lo facturado](https://github.com/LemontechSA/ttb/pull/77)
* **Fixed:** [Correcci�n a la direcci�n en la carta de Morales y Besa](https://github.com/LemontechSA/ttb/pull/93)
* **New:** [Agrupador de �rea del trabajo en reportes avanzados](https://github.com/LemontechSA/ttb/pull/94)
* **Fixed:** [Correcci�n al ingresar documentos de pago sin NuevoModuloFactura](https://github.com/LemontechSA/ttb/pull/96)
...
* **Fixed** [Mustra Duraci�n correctamente](https://github.com/LemontechSA/ttb/pull/95)

## Hotfix: 13.1.7
Viernes 22 de febrero 2013.
* **Fixed** [Ocultar bot�n "Copiar datos de Cliente"](https://github.com/LemontechSA/ttb/pull/92)
...
## Hotfix: 13.1.2
Lunes 18 de febrero 2013.
* **Fixed** [Corrige la creaci�n de clientes](https://github.com/LemontechSA/ttb/pull/85)
...
* **New:** [Refactorizaci�n y mejoras al Cron](https://github.com/LemontechSA/ttb/pull/55)
...
Mi�rcoles 6 de febrero 2013.
* **Fixed** [Evita error en IE cuando los abogados no pueden ver la duraci�n cobrable] (http://soporte.thetimebilling.com/tickets/7618?col=22917348&page=1)
...
* **Fixed:** [Modificaci�n a agregar contrato y asunto para recuperar tarifa plana](https://github.com/LemontechSA/ttb/issues/64)
* **Fixed:** [Correcci�n para el cron que ingresa datos al demo no termine su ejecuci�n](https://github.com/LemontechSA/ttb/issues/64)
* **Fixed:** [Modificaci�n a agregar contrato para definir tarifa trámites](https://github.com/LemontechSA/ttb/issues/64)
...
* **New:** [Se agregan los campos giro y lugar de emisi�n a la factura factura](https://github.com/LemontechSA/ttb/issues/49)
* **New:** [Restablecer Password](https://github.com/LemontechSA/ttb/issues/48)
* **New:** [Muestra la versi�n de software que está corriendo un ambiente](https://github.com/LemontechSA/ttb/issues/45)
* **New:** [Elimina popup al descargar excel revisar horas](https://github.com/LemontechSA/ttb/issues/43)
* **New:** [filtra correos según direcci�n válida](https://github.com/LemontechSA/ttb/issues/39)
* **Fixed:** [Traducci�n a anchor %fecha_con_de% al inglés](https://github.com/LemontechSA/ttb/issues/37)
...
* **Fixed:** [Diferencias en el c�digo del profesional en los trámites de Cobro entre Archivo Excel y Word](https://github.com/LemontechSA/ttb/pull/59)
...
* **Fixed:** [Corrige la secci�n cliente de la nota de cobro cuando se utiliza desde la factura](https://github.com/LemontechSA/ttb/pull/57)
...
* **Fixed:** [Permite ingresar trabajos con c�digo secundario](https://github.com/LemontechSA/ttb/commit/f1392f48fe40f22d11d4916ae47d40daf984eb4b)
...
* **New:** [Nuevo sistema de Avisos de actualizaci�n](https://github.com/LemontechSA/ttb/issues/5)
* **New:** [Utilizaci�n de cache para Conf::GetConf()](https://github.com/LemontechSA/ttb/issues/10)
* **New:** [Autoloader de clases en el sistema](https://github.com/LemontechSA/ttb/issues/13)
* **New:** [Utilizaci�n de miconf.php para desarrollo local sin adddb.php](https://github.com/LemontechSA/ttb/issues/15)
* **New:** [Nuevo sistema de deploy automático con notificaciones al equipo](https://github.com/LemontechSA/ttb/issues/17) y #25
* **Fixed:** [Correcci�n de impresi�n con Mediaprint CSS para reporte de saldo](https://github.com/LemontechSA/ttb/issues/19)
