...
#    Entonces debiera ver "Gastos y Provisiones"
  ...
  Escenario: filtro provisiones y edito la primera
    ...
    Entonces debiera ver "Convertir en Adelanto"
    Cuando pincho el seudoboton "Convertir en Adelanto"
    Entonces debiera ver "La Provisión se ha convertido"
    Cuando pincho el seudoboton "Cancelar"
    Y me cambio de ventana