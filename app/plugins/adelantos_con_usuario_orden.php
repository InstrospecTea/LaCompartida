...
function Ingresar_Adelantos_Con_Usuario_Orden() {
	...
	if (array_key_exists('id_usuario_orden',$documento->fields) && !empty($id_usuario_orden)) $documento->Edit('id_usuario_orden', $id_usuario_orden);
	if (array_key_exists('id_usuario_ingresa',$documento->fields) && !empty($id_usuario_ingresa)) $documento->Edit('id_usuario_ingresa', $id_usuario_ingresa);
