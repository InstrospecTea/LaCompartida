...
function Honorarios_Notariales_Js_Footer_Light() {
	...
	$boton_tramites='<a class=\"btn botonizame\"  alt=\"'.$tramites_disponibles .'\" icon=\"ui-icon-invoice\" rel=\"'.__('Trámites').'\" id=\"facturar_tramites\" setwidth=\"210\" >'.  __('Facturar '. __('Trámites')) .'</a>&nbsp;&nbsp;';
	$boton_trabajos='<a class=\"btn botonizame\" alt=\"'.$monto_trabajo.'\"  icon=\"ui-icon-invoice2\"  rel=\"'.__('Honorarios legales').'\"  id=\"facturar_trabajos\"   setwidth=\"220\"  >'.  __('Facturar '. __('Honorarios Legales')) .'</a>&nbsp;&nbsp;';
