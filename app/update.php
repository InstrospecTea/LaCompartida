...
ADD  `condicion_pago` TINYINT( 2 ) NOT NULL DEFAULT  '0' AFTER  `comprobante_erp` ;";
		...
		case 5.27:
			...
			break;
                        ...
                        case 5.30:
                            $query = array();
                            $query[] = "INSERT INTO  `configuracion` (  `id` , CREATE TABLE IF NOT EXISTS `log_db` (
  `id` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1; `glosa_opcion` ,  `valor_opcion` ,  `comentario` ,  `valores_posibles` ,  `id_configuracion_categoria` ,  `orden` ) 
                                            VALUES (
