...
(240, 716, 'ZW', 'ZWE', 'Zimbabue', 0);";
					...
					case 4.39:
						...
						$query[] = "INSERT INTO  `menu_permiso` (  `codigo_permiso` ,  `codigo_menu` ) VALUES ('COB',  'FACT_PAGO');";
						foreach($query as $q)
							if(!($res = mysql_query($q,$dbh))) throw new Exception($q."---".mysql_error());
					break;
...
WHERE  `id` =105 LIMIT 1 ;";
			...
			case 4.50:
						...
						$query[] = "INSERT INTO `prm_excel_cobro` (`id_prm_excel_cobro`, `nombre_interno`, `glosa_es`, `glosa_en`, `tamano`, `grupo`) VALUES (NULL, 'fecha_anyo', 'A�o', 'Year', '6', 'Listado de trabajos');";
						...
						$query[] = "INSERT INTO `prm_excel_cobro` (`id_prm_excel_cobro`, `nombre_interno`, `glosa_es`, `glosa_en`, `tamano`, `grupo`) VALUES (NULL, 'fecha_anyo', 'A�o', 'Year', '6', 'Listado de tr�mites');";
		 ...
		 case 4.59:
			...
			case 4.65:
				...
				$query[] = "INSERT INTO  `configuracion_categoria` (  `id_configuracion_categoria` ,  `glosa_configuracion_categoria` ) VALUES (NULL ,  'Opciones Impresi�n Carta');";
			...
			case 4.66:
				$query = array();
				$query[] = "INSERT INTO  `configuracion` (  `id` ,  `glosa_opcion` ,  `valor_opcion` ,  `comentario` ,  `valores_posibles` ,  `id_configuracion_categoria` ,  `orden` ) VALUES (NULL ,  'MostrarBotonCobroPDF',  '0',  'Dar la opci�n de bajar Pre-liquidaci�n (Word de cobros) en formato PDF',  'boolean',  '6',  '-1');";
