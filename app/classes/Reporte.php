...
class Reporte {
	...
	public function sSELECT() {
		...
		switch ($this->tipo_dato) {
			...
			case 'rentabilidad':
				/* Se necesita resultado extra: lo que se habrÃ­a cobrado */
	...
	public function Query() {
		...
		// En caso de filtrar por área o categorÃ­a de usuario no se toman en cuenta los cobros sin horas.
		if (
	...
	//Arregla espacios vacÃ­os en Barras: retorna data con los labels extra de data2.
	...
	//Arregla espacios vacÃ­os en Arreglos. Retorna data con los campos extra en data2 (rellenando con 0).
