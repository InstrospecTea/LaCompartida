					...
					if($resp)
						{
							if( $this->fields['egreso'] > 0 )
								{
									$query = "INSERT INTO gasto_historial	
															( id_movimiento, fecha, accion, id_usuario, fecha_movimiento, codigo_cliente, codigo_asunto, egreso, monto_cobrable, descripcion, id_moneda) 
															VALUES( ".$this->fields['id_movimiento'].", NOW(), 'ELIMINAR', ".$this->sesion->usuario->fields['id_usuario'].", '".$this->fields['fecha']."', '".$this->fields['codigo_cliente']."', '".$this->fields['codigo_asunto']."', ".$this->fields['egreso'].", ".$this->fields['monto_cobrable'].", '".$this->fields['descripcion']."', ".$this->fields['id_moneda'].")";
								}
							else if( $this->fields['ingreso'] > 0 )
								{
									$query = "INSERT INTO gasto_historial
															...
															VALUES( ".$this->fields['id_movimiento'].", NOW(), 'ELIMINAR', ".$this->sesion->usuario->fields['id_usuario'].", '".$this->fields['fecha']."', '".$this->fields['codigo_cliente']."', '".$this->fields['codigo_asunto']."', ".$this->fields['ingreso'].", ".$this->fields['monto_cobrable'].", '".$this->fields['descripcion']."', ".$this->fields['id_moneda'].")";
								}
							mysql_query($query,$this->sesion->dbh) or Utiles::errorSQL($query,__FILE__,__LINE__,$this->sesion->dbh);
						}
				}
