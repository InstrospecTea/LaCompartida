...
abstract class MimeTypes {
	...
	/**
	 * @var array Mapping files of office to extension;
	 */
	protected static $officeFiles = [
	...
	public static function getExtension($mime_type) {
		...
		return isset(self::$extensions[$mime_type]) ? self::$extensions[$mime_type] : null;
	}

	public static function fromOfficeFiles($file) {
		return isset(self::$officeFiles[$file]) ? self::$officeFiles[$file] : null;
	}

	private static function getExtensions() {
		if (empty(self::$extensions)) {
			self::$extensions = array_flip(self::$mimetypes)
			+ [
