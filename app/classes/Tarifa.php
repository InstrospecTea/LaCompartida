...
class Tarifa extends Objeto {
	...
	function GuardaTarifaFlat($valor, $id_moneda, $id_tarifa = null) {
		...
		if (!empty($id_tarifa)) {
			...
			$this->verificaTarifaFlatUsuarios($id_tarifa, $id_moneda, $valor);
				return $id_tarifa;
			}
		}
		...
		if ($tarifa !== false) {
			$this->verificaTarifaFlatUsuarios($tarifa[$this->campo_id], $id_moneda, $valor);
	 ...
	 * @param type $valor
	 */
	public function verificaTarifaFlatUsuarios($id_tarifa, $id_moneda, $valor) {
