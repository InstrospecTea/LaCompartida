...
class Notificacion {
	...
	function estructura($tipo_mail) {
		...
		switch ($tipo_mail) {
			 ...
			 *  -Modificaci贸n de Contratos de los que es responsable el Usuario
			 *  -Transgresi贸n de l铆mites de Asunto
			 *  -Transgresi贸n de l铆mites de Contratos
			 */
			case 'diario':
				$mail = array();
				$mail['header'] =
	...
	/* Parseo y emisi贸n de mail Semanal */
	...
	/* Parseo y emisi贸n de mail Diario */
	...
	/* Parseo y emisi髇 de aviso de generaci髇 de cobros programados */
