...
class WsFacturacionNubox extends WsFacturacion{
	...
	public function getPdf($id) {
		...
		try {
			...
			$this->setError(1, __("Nubox: El archivo no se puede descargar en este momento; Por favor intente m�s tarde. DTE ID: {$id}"));
	...
	private function login() {
		...
		try {
			...
			// Por parte de los prestadores de servicio, y la actualización
			...
			// explícita un cipher de ssl. Si no se agrega este contexto en la
