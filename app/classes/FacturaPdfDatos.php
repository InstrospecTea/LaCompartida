	...
	function CargarGlosaDato($tipo_dato, $id_factura) {
		...
		switch ($condicion_pago) {
			case '1': $condicion_pago = __('CONTADO');
				break;
			case '3': $condicion_pago = __('Vencimiento 15 d�as	');
				break;
			case '4': $condicion_pago = __('Vencimiento 30 d�as	');
				break;
			case '5': $condicion_pago = __('Vencimiento 45 d�as	');
				break;
			case '6': $condicion_pago = __('Vencimiento 60 d�as	');
				break;
			case '7': $condicion_pago = __('Vencimiento 75 d�as	');
				break;
			case '8': $condicion_pago = __('Vencimiento 90 d�as	');
				break;
			case '9': $condicion_pago = __('Vencimiento 120 d�as');
				break;
			case '12': $condicion_pago = __('Letra 30 d�as');
				break;
			case '13': $condicion_pago = __('Letra 45 d�as');
				break;
			case '14': $condicion_pago = __('Letra 60 d�as');
				break;
			case '15': $condicion_pago = __('Letra 90 d�as');
				break;
			case '18': $condicion_pago = __('Cheque 30 d�as');
				break;
			case '19': $condicion_pago = __('Cheque 45 d�as');
				break;
			case '20': $condicion_pago = __('Cheque 60 d�as');
				break;
