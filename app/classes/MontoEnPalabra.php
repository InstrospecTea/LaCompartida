...
class MontoEnPalabra extends Objeto {
	var $Void = '';
	var $SP = ' ';
	var $Dot = '.';
	var $Zero = '0';
	...
	function MontoEnPalabra($sesion = '', $fields = '', $params = '') {
		if ($sesion == "") {
			global $sesion;
		}
	}

	function ValorEnLetras($x, $id_moneda, $glosa_moneda = null, $glosa_moneda_plural = null, $considera_ceros = false) {
		$s = '';
		$Ent = '';
		$Frc = '';
		$Signo = '';
		...
		$Moneda = $this->MonedaGlosa($x, $id_moneda, $glosa_moneda, $glosa_moneda_plural);
	...
	function MonedaGlosa($monto,$id_moneda,$glosa_moneda,$glosa_moneda_plural) {
		if ($monto > 1) {
			$en = $glosa_moneda_plural;
		} else {
			$en = $glosa_moneda;
		}
