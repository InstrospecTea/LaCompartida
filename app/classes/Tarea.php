...
class Tarea extends Objeto {
	...
	function Write() {
		...
		foreach ($users as $user) {
			...
			$mensaje = "Estimado Sr. {$nombre}, <br/><br/>{$estado} <br><br> Cliente: {$nombre_cliente}<br/> {$texto_asunto} Tarea: {$this->fields['nombre']}<br/><br/> Para ingresar haga clic (<a href={$url}>aquí­</a>).";
