...
class HorasCastigadasDataCalculator extends AbstractDataCalculator {
	...
	function getReportWorkQuery(Criteria $Criteria) {
		$horas_castigadas = "IF(
		(SUM(TIME_TO_SEC(trabajo.duracion) - TIME_TO_SEC(trabajo.duracion_cobrada)) / 3600) > 0,
		 SUM(TIME_TO_SEC(trabajo.duracion) - TIME_TO_SEC(trabajo.duracion_cobrada)) / 3600,
		0)";
