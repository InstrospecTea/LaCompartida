<?php
/**
 * Agrupador por Día de la emisión de la liquidación
 *
 * * Agrupa por: IF(cobro.fecha_emision IS NULL, 'Por Emitir', DATE_FORMAT(cobro.fecha_emision, '%d-%m-%Y'))
 * * Muestra: IF(cobro.fecha_emision IS NULL, 'Por Emitir', DATE_FORMAT(cobro.fecha_emision, '%d-%m-%Y'))
 * * Ordena por:  cobro.fecha_emision
 *
 * Más info en: https://github.com/LemontechSA/ttb/wiki/Reporte-Agrupador:-Dia-Emision
 */
class DiaEmisionGrouper extends AbstractGrouperTranslator {
	...
	function getGroupField() {
		return "IF(cobro.fecha_emision IS NULL, 'Por Emitir', DATE_FORMAT(cobro.fecha_emision, '%d-%m-%Y'))";
	}
	...
	function translateForCharges(Criteria $Criteria) {
		$Criteria
			->add_select($this->getSelectField(), 'dia_emision')
