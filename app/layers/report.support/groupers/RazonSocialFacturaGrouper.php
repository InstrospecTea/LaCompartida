<?php
/**
 * Agrupador por Razón Social de Factura
 *
 ...
 */
class RazonSocialFacturaGrouper extends AbstractGrouperTranslator {
	...
	function getGroupField() {
		return "CONCAT(factura.glosa_cliente, ' (', factura.rut_cliente, ')')";
	}
	...
	function translateForCharges(Criteria $Criteria) {
		$Criteria
			->add_select("IFNULL({$this->getSelectField()}, 'Indefinido')", 'razon_social_factura')
