<form role="form" id="form_doc" method="post" style="display:block; position: absolute; width: 100%; height: 100vh; left: 0px; top: 0px; margin: 0px; padding: 0px;">
    ...
    <div class="container-fluid">
        <div class="row" style="padding: 15px 0;">
            ...
            <div class="col-sm-4"><?php echo $this->Form->select('carta[id_carta]', $cartas, $id_carta, array('class' => 'form-control')); ?></div>
                        ...
                        <div id="content" style="height: calc(100vh - 70px - 60px - 30px);">
                            <div id="my-tab-content" class="tab-content">
                                <div class="tab-pane active" id="html_code">
                                    ...
                                    <textarea class="ckeditor" id="carta_formato" name="carta[formato]" style="width:100%; height: calc(100vh - 70px - 60px - 30px - 45px); margin-top: 10px;"></textarea>
                                </div>
