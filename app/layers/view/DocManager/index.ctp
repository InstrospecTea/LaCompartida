					...
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-md-3 text-right">
								<button id="btn_previsualizar" name="btn_previsualizar" class="btn btn-default" type="button"><span class="glyphicon glyphicon-print"></span> Descargar</button>
							</div>
						</div>
					</div>
					<div class="panel-body noPad" style="overflow-y:auto; height: calc(100vh - 134px);">
