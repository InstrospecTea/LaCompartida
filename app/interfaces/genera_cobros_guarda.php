	...
	try {
		...
		if ($totaldecobros > 0) {
			...
			$detalle_error = '<div id="sql_error" style="margin: 0px auto  0px; width: 414px; border: 1px solid #00782e; padding: 5px; font-family: Arial, Helvetica, sans_serif;font-size:12px;">
				...
				<div style="padding:10px;text-align:center"><strong style="font-size:14px">Atenci�n</strong><br/><br/>Error al intentar generar los borradores seg�n periodo, no hay datos para los filtros que Ud. ha seleccionado</div>
			</div>
