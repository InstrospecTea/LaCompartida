...
$usuarios = $usuario->get_usuarios_horas($p_revisor, $p_secretaria);

$select_usuario = $Form->select('id_usuario', $usuarios->rows, $id_usuario, array('empty' => $usuarios->todos, 'style' => 'width: 200px'));
