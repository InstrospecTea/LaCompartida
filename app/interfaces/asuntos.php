		...
		<fieldset class="tb_base"  width="90%">
			...
			<table style="border: 0 none" width='90%'>
				...
				<tr>
					...
					<td class="al" colspan="3">
						<?php echo Html::SelectArrayDecente($PrmTipoProyecto->Listar('ORDER BY orden, glosa_tipo_proyecto ASC'), 'id_tipo_asunto', $id_tipo_asunto, '', 'Todos', '300px'); ?>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
