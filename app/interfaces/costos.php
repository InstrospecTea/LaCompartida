...
?>
	...
	<?php } else { ?>
					<img src='<?php echo Conf::ImgDir() . "/derecha.gif" ?>' <?php echo $tip_siguiente ?> class='mano_on' onclick="CambiaFecha('<?php echo $fecha_m > 6 ? $fecha_a + 1 : $fecha_a ?>', '<?php echo $fecha_m > 6 ? $fecha_m - 6 : $fecha_m + 6 ?>')">
<?php } ?>
