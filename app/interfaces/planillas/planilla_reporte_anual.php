...
Log::write(memory_get_usage(true) . ' bites', 'cps');
...
if ($usa_reporte_horas) {
	...
	unset($encabezados, $query, $resp, $cliente, $tasa, $flat_fee, $retainer, $proporcional, $cap, $no_cobrable);
}
$fila_fin = $fila - 1;
...
if ($usa_reporte_horas) {
	...
	unset($encabezados, $query, $resp, $profesional, $tasa, $flat_fee, $retainer, $proporcional, $cap, $no_cobrable);
}
$fila_fin = $fila - 1;
...
if ($usa_reporte_horas) {
	...
	unset($encabezados, $query, $resp, $forma_cobro, $duracion);
}
$fila_fin = $fila - 1;
...
if ($usa_reporte_horas) {
	...
	unset($encabezados, $query, $resp, $mes, $fecha, $tasa, $flat_fee, $retainer, $proporcional, $cap, $no_cobrable);
}
$fila_fin = $fila - 1;
...
unset($encabezados, $query, $resp, $liquidadas, $por_liquidar, $incobrables, $castigadas, $no_cobrables, $declaradas);
//HOJA 8 TABLA 1
...
unset($encabezados, $query, $resp, $cliente, $liquidadas, $por_liquidar, $incobrables, $castigadas, $no_cobrables, $declaradas);
$fila_fin = $fila - 1;
...
unset($encabezados, $query, $resp, $usuario, $liquidadas, $por_liquidar, $incobrables, $castigadas, $no_cobrables, $declaradas);
$fila_fin = $fila - 1;
