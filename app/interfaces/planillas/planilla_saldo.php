...
$codigo_cliente_request = $_REQUEST['codigo_cliente'];
$codigo_cliente = $codigo_cliente_request;

if (Conf::GetConf($Sesion, 'CodigoSecundario')) {
    $codigo_cliente_request = $_REQUEST['codigo_cliente_secundario'];
    $codigo_cliente_secundario = $codigo_cliente_request;
   
    $Cliente = new Cliente($Sesion);
    $Cliente->LoadByCodigoSecundario($codigo_cliente_request);
    $codigo_cliente = $Cliente->fields['codigo_cliente'];
}

if (in_array($_REQUEST['opcion'], array('buscar', 'xls', 'json')) && !empty($codigo_cliente)) {
                    ...
                    <table style="border: 0px solid black" width='720px'>
                        <tr>
                            ...
                            <td colspan="3" align="left">
                                <?php echo UtilesApp::CampoCliente($Sesion, $codigo_cliente_request,$codigo_cliente_secundario,$codigo_asunto,$codigo_asunto_secundario); ?>
                            </td>
                        </tr>
...
<?php
if ($_REQUEST['opcion'] == 'buscar' && !empty($codigo_cliente)) {
