<?
	...
	if($vs=='cliente')
		$query = "SELECT 
							...
							LEFT JOIN usuario_tarifa as usuario_tarifa_contrato ON
								trabajo.id_usuario=usuario_tarifa_contrato.id_usuario=1 AND
								usuario_tarifa_contrato.id_moneda=$id_moneda_seleccionada AND
								contrato.id_tarifa=usuario_tarifa_contrato.id_tarifa
							LEFT JOIN usuario_tarifa as usuario_tarifa_standard ON
								trabajo.id_usuario=usuario_tarifa_standard.id_usuario AND
								usuario_tarifa_standard.id_moneda=$id_moneda_seleccionada AND
