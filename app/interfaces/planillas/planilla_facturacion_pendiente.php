<?
	...
	if($xls)
	{
		...
		$ws1->write($filas, $col_estado_ultimo_cobro, __('Estado ultimo cobro'), $formato_titulo);
		...
		$ws1->write($filas, $col_valor_en_moneda_base_segun_THH, __('Valor en $ seg˙n THH'), $formato_titulo);
