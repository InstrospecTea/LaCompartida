<?
	...
	$glosa_dato['horas_no_cobrables'] = "Total de Horas Trabajadas en asuntos no Cobrables";
	$glosa_dato['horas_castigadas'] = "Diferencia de Horas Cobrables con las Horas que ve el cliente en nota de Cobro";
	$glosa_dato['horas_visibles'] = "Horas que ve el Cliente en nota de cobro (tras revisión)";
	$glosa_dato['horas_cobradas'] = "Horas Visibles en Cobros que ya fueron Emitidos";
	$glosa_dato['horas_por_cobrar'] = "Horas Visibles que aún no se Emiten al Cliente";
	$glosa_dato['horas_pagadas'] = "Horas Cobradas en Cobros con estado Pagado";
	$glosa_dato['horas_por_pagar'] = "Horas Cobradas que aún no han sido pagadas";
	$glosa_dato['horas_incobrables'] = "Horas en Cobros Incobrables";
	$glosa_dato['valor_por_cobrar'] = "Valor monetario estimado que corresponde a cada Profesional en horas por cobrar";
	$glosa_dato['valor_cobrado'] = "Valor monetario que corresponde a cada Profesional, en un Cobro ya Emitido";
	$glosa_dato['valor_pagado'] = "Valor Cobrado que ha sido Pagado";
	$glosa_dato['valor_por_pagar'] = "Valor Cobrado que aún no ha sido pagado";
	$glosa_dato['valor_por_pagar'] = "Valor Cobrado en Cobros Incobrables";
	$glosa_dato['rentabilidad'] = "Razón entre el Valor Cobrado, y lo que se habría cobrado usando THHs Estándar";
	$glosa_dato['valor_hora'] = "Valor Cobrado por cada Hora Cobrada";
	...
	$tipos_moneda = array('valor_cobrado','valor_por_cobrar','valor_pagado','valor_por_pagar','valor_hora','valor_incobrable','diferencia_valor_estandar');
...
function Generar(form, valor)
{
	...
	else if(valor == 'tabla')
	{
		...
		form.action = 'reporte_avanzado_2.php';
	form.submit();
}
...
<?
	...
	switch($opc)
	{
		case 'print':
		{
			$url_iframe = "reporte_avanzado_planilla_2.php?popup=1";
			break;
		}
		case 'circular':
		{
