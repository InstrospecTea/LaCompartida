...
<legend><?php echo 'Filtros'?></legend>
	<table  >
		...
		<?php echo ' Caja impuesto usando Overloaded Html:'. UtilesApp::impuestos($sesion, 'valor_impuesto', 'ValorImpuesto', 10, true); ?>
...
$sesionestatica=Sesion::getSesion();
echo 'Leyendo desde Sesión Estática:<pre>';print_r($sesionestatica->usuario->fields);echo '</pre>';
