...
<tr>
    <td align=right>
        <img src="<?=Conf::ImgDir()?>/agregar.gif" border=0> <a href=# onclick="nuevaVentana('Agregar_Contrato',730,600,'agregar_contrato.php?popup=1&codigo_cliente=<?=$codigo_cliente?>');" title="<?=__('Agregar contrato')?>"><?=__('Agregar contrato')?></a>
    </td>
</tr>
</table>
<?
    ...
    function Opciones(& $fila)
    {
        ...
        return 
		"<a href=# onclick=\"nuevaVentana('Editar_Contrato',730,600,'agregar_contrato.php?id_contrato=$id_contrato&popup=1');\" title='Editar Contrato'><img src='".Conf::ImgDir()."/editar_on.gif' border=0 title=Editar Contrato></a>"
