...
?>
				...
				<?php if(!$factura->loaded() && $id_cobro && $id_documento_legal!=2){
					...
					if($saldo > 0){ ?>
							if(confirm('<?=__('Existen adelantos por ').$simbolo.' '.number_format($saldo, $cifras_decimales).__(' asociados a esta liquidación. ¿Desea utilizarlos para saldar esta ').$tipo_documento_legal.'?'?>')){
