...
if ($popup) {
	...
	<?php echo __('Emitir') . ' ' . __('Cobro') . __(' :: Selección de Gastos #') . $id_cobro . __(' ') . $nombre_cliente; ?>
			</td>
		</tr>
	</table>
	<br>
...
<?php if ($solo_gastos) { ?>
	...
	<?php echo __('Fecha desde') ?>:
	                    ...
	                    <td align='left' colspan='3'>
	                        ...
	                        <input type="text" name="fecha_ini" class="fechadiff" value="<?php echo (empty($fecha_ini) or $fecha_ini == "0000-00-00") ? "" : date("d-m-Y", strtotime($fecha_ini)) ?>" id="fecha_ini" size="11" maxlength="10" />
	                       
							<?php echo __('Fecha hasta') ?>:&nbsp;
	                        <input type="text" name="fecha_fin" class="fechadiff"  value="<?php echo (empty($fecha_fin) or $fecha_fin == "0000-00-00") ? "" : date("d-m-Y", strtotime($fecha_fin)) ?>" id="fecha_fin" size="11" maxlength="10" />
