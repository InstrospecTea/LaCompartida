...
<form name="formulario" id="formulario" method="post">
	...
	<table>
		...
		<tr>
			...
			<td align="left">
				<input id="codigo_asunto" name="codigo_asunto" <?php echo $codigo_obligatorio ? 'readonly="readonly"' : '' ?> size="10" maxlength="11" value="<?php echo $asunto->fields['codigo_asunto'] ?>" onchange="this.value = this.value.toUpperCase();<?php
				if (!$asunto->Loaded()) 
					echo "CheckCodigo();";
				?>"/>
				&nbsp;&nbsp;&nbsp;
		...
		<?php
			...
			$query_encargado = "SELECT usuario.id_usuario,CONCAT_WS(' ',apellido1,apellido2,',',nombre)
									FROM usuario
			...
			echo '<tr>';
				...
				echo '<td align="left">';
					...
					echo Html::SelectQuery($sesion, $query_encargado, "id_encargado", $asunto->fields['id_encargado'], "  ", "Seleccione", "200");
			...
			if (Conf::GetConf($sesion, 'AsuntosEncargado2')) {
					
				$query_encargado2 = "SELECT usuario.id_usuario,CONCAT_WS(' ',apellido1,apellido2,',',nombre)
										FROM usuario
											WHERE usuario.id_usuario IN (SELECT id_usuario FROM usuario_permiso)
												AND usuario.activo = 1
													ORDER BY usuario.apellido1";
				echo '<tr>';
					echo '<td align=right>' . __('Encargado 2') . '</td>';
					echo '<td align=left>'; 	
						echo Html::SelectQuery($sesion, $query_encargado2, "id_encargado2", $asunto->fields['id_encargado2'], "", "Seleccione", "200");
					echo '</td>';
				echo '</tr>';
	...
	<?php
		...
		$permisos_asuntos = $sesion->usuario->permisos->Find('FindPermiso', $params_asuntos_array);
