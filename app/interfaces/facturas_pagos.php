<?
	...
	{
		global $idioma;
		return $fila->fields['monto_aporte'] > 0 ? $fila->fields['simbolo'].' '.number_format($fila->fields['monto_aporte'],$fila->fields['cifras_decimales'],$idioma->fields['separador_decimales'],$idioma->fields['separador_miles']) : '';
	}
