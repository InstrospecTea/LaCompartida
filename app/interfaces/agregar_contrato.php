...
$conf_validaciones_cliente = Conf::GetConf($Sesion, 'ValidacionesCliente');

if ($conf_validaciones_cliente){
...
<script type="text/javascript">
	...
	function ValidarContrato(form) {
		...
		<?php if ($conf_validaciones_cliente) { ?>
...
<?php } ?>
	...
	<?php if (Conf::GetConf($Sesion, 'SetFormatoRut')) {
	...
	<table   id='datos_carta' style='display:<?php echo $show ?>' width="100%">
		...
		<tr>
			...
			<td align="left" colspan='5'>
				<?php if ($contrato->fields['opc_papel'] == '' && Conf::GetConf($Sesion, 'PapelPorDefecto')) {
