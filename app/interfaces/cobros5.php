...
if ($opc == 'anular_emision') {
...
} else if ($opc == 'guardar_cobro' || $opc == 'guardar_cobro_pdf') { #Guardamos todos los datos del cobro
	...
	if ($accion == 'emitir' && $ret == '') {	 ##################### EMISION ######################
	...
	} else if ($accion == 'imprimir' && $ret == '') {  #################### IMPRESION #####################
		...
		exit;
	} else if ($accion == 'anterior') {		 ################## ANTERIOR PASO ###################
