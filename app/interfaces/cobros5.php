...
<?
	...
	$tip_suma				= __("Es un �nico monto de dinero para el asunto. Aqu� interesa llevar la cuenta de HH para conocer la rentabilidad del proyecto. Esta es la �nica modalidad de ") . __("cobro") . __(" que no puede tener l�mites.");
