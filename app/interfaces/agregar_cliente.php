...
<?= __('Nombre') ?>
									...
									<?php
											...
											/*
											 * comenté esto, por que cualquier usuario puede ser encargado secundario
                ...
                OR usuario.id_usuario IN ('$id_usuario','" . $sesion->usuario->fields['id_usuario'] . "')";*/
									...
									<tr style="display: <?php echo UtilesApp::GetConf($sesion, "CopiarEncargadoAlAsunto") ? 'none' : 'block' ?>">
										<td align="right">
