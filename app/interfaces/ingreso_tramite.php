	...
	<table class="border_plomo" id="tbl_trabajo" width="100%">
		...
		<tr>
			...
			<td align="left" valign="top">
				...
				if (in_array((int) Conf::GetConf($sesion, 'OrdenadoPor'), array(1, 2))) {
					if (!empty($t)) {
						$value_input_solicitante = $t->fields['solicitante'] ? $t->fields['solicitante'] : $solicitante;
					} else {
		...
		<tr>
			...
			<td>
				...
				?>
				<label>
					<input type="checkbox" name="como_trabajo" id="como_trabajo" value="1" onClick="ShowTime();ToggleCantidad(this.checked);" <?php echo $tramite->fields['trabajo_si_no'] || $como_trabajo ? 'checked' : '' ?>>
