...
if ($_GET['id_documento_legal'])
	$id_documento_legal = $_GET['id_documento_legal'];
...
if ($opc == 'dibuja_tabla') {
	...
	$query = "SELECT SQL_CALC_FOUND_ROWS *
		...
		WHERE factura_pdf_datos.id_documento_legal = '$id_documento_legal' AND factura_pdf_datos.id_estudio = '$id_estudio'
