...
if (isset($pago_honorarios)) {
	$filtros['pago_honorarios'] = $pago_honorarios;
}
if (isset($pago_gastos)) {
	$filtros['pago_gastos'] = $pago_gastos;
}
if (isset($id_contrato)) {
	$filtros['id_contrato'] = $id_contrato;
}
if (isset($moneda)) {
...
if (isset($_REQUEST['id_solicitud_adelanto']) && !empty($_REQUEST['id_solicitud_adelanto'])) {
	$filtros['id_solicitud_adelanto'] = $_REQUEST['id_solicitud_adelanto'];
	$query .= " AND documento.id_solicitud_adelanto = " . $filtros['id_solicitud_adelanto'];
}
