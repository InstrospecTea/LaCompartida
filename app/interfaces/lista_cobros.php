...
<?
  ...
  function Opciones(& $fila)
  {
     ...
     . "&nbsp;&nbsp;&nbsp;<a onclick=\"return confirm('".__('¿Está seguro de eliminar el cobro?')."')\" href=?id_cobro=$id_cobro&opc=eliminar&desde=$desde title='Eliminar cobro'><img src='".Conf::ImgDir()."/cruz_roja.gif' border=0 alt='Eliminar' /></a>";
  }
?>
<script type="text/javascript">
Calendar.setup(
