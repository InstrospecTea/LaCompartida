...
?>
	...
	if(cambio)
	{
		if(confirm('Ud. está modificando un trabajo que pertenece <?php echo __('al cobro'); ?>: '+id_cobro[i]+' . Si acepta, el trabajo eventualmente se desvinculará de este <?php echo __('cobro'); ?> y eventualmente se vinculará a <?php echo __('un cobro'); ?> pendiente para el nuevo asunto en caso de que exista.'))
		{
