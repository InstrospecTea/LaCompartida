...
if(!$papel || $papel='') $papel='LETTER';
$doc = new DocGenerator($html, $cssData, $papel, false, 'PORTRAIT', $docm_top, $docm_right, $docm_bottom, $docm_left, 'EMITIDO', '', $configuracion, $docm_header, $docm_footer);
