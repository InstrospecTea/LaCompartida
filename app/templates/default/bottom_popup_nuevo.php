...
<script type="text/javascript">
  ...
  function downloadJSAtOnload() {
    var url = _sf_async_config.pathseguro;
    if (url !== undefined) {
      if (jQuery('#DigiCertClickID_iIR9fwBQ').length>0) {
        ...
        if ("https:" == document.location.protocol) {
          ...
          jQuery('#DigiCertClickID_iIR9fwBQ').html('<a style="border:0;text-decoration:none;" href="' + url + '"><img src="https://estaticos.thetimebilling.com/images/no_ssl_cifrado.png" style="text-decoration:none;vertical-align:top;border: 0 none;margin-top:0;position:relative;top:0;right:0;" /></a>');
        }
      }
    }
  }
