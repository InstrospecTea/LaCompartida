...
task :create_database do
  ...
  if (proceed == 'y' || proceed == 'Y'  || proceed == 's' || proceed == 'S'  )
    run "  mysql -h192.168.1.24  -uroot -pasdwsx -e 'create database #{dbname}' && mysqldump -h192.168.1.24 -uroot -pasdwsx --opt  lemontest_molde | mysql -h192.168.1.24  -uroot -pasdwsx #{dbname}"
  end
