...
<head>
    ...
    jQuery('#recuerdame').tooltip( {animation:true, placement:'right',title:'Seleccione esta opci�n si desea recordar sus datos de acceso en este equipo.'});
    jQuery('#usar_ad').tooltip( {animation:true, placement:'right',title:'Seleccione esta opci�n si desea autentificar con usuario y contrase�a de ActiveDirectory.'});
     });
    </script>
</head>
<body>
            ...
            <table width="100%"   cellspacing="2" cellpadding="2" id="maintable"  >
                ...
                <tr>
                    <td  class="alert alert-block">
                        ...
                        <p>Por favor, cont&aacute;ctese con <a href="mailto:tesoreria@lemontech.cl">tesoreria@lemontech.cl</a> o al n&uacute;mero <b>+56 229638160</b> para regularizar su situaci&oacute;n.</p>
                    </td>
                </tr>
            </table>
        </div>
