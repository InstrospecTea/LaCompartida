...
Ext.DatePicker = Ext.extend(Ext.Picker, {
	...
	//alert('toy en el getvalue');
	var hola = new Date(value.year, value.month-1, day);
	//alert(hola);
        return hola;
    },
...
Ext.MessageBox = Ext.extend(Ext.Sheet, {
	...
	//atributos para el uso de un reloj
	start:false,
	intervalID:null,
	interval:100,
    ...
    clock : function(title, msg, fn, scope) {
        return this.show({
            title : title,
            msg   : msg,
            buttons: Ext.MessageBox.START_STOPOK,
            fn    : fn,
            scope : scope,
	...
	doClock: function(){
		Ext.Msg.updateText('==> '+Ext.Msg.tiempo,true) ;
		Ext.Msg.tiempo=Ext.Msg.tiempo+1;	
	},
...
(function(){
    ...
    Ext.apply(B, {
		...
		START    : {text : 'start',    itemId : 'start', ui : 'action' },
		STOP    : {text : 'stop',    itemId : 'stop', ui : 'action' },
		STARTSTOP    : {text : '> / ||',    itemId : 'start_stop', ui : 'action' },
    ...
    Ext.apply(B, {
		...
		STARTSTOPCANCEL : [B.START, B.CANCEL, B.STOP],
        START_STOPOK : [B.STARTSTOP,B.OK],
    });
