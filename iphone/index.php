...
function wsClient() {
	return new SoapClient(Conf::Host().'/web_services/webservices.php?wsdl');
}
...
function obtener_clientes() {
	return json(wsClient()->EntregarListaClientes($_POST['rut'], $_POST['password']));
}

dispatch_post('/asuntos', 'obtener_asuntos');
function obtener_asuntos() {
	return json(wsClient()->EntregarListaAsuntos($_POST['rut'], $_POST['password']));
}
