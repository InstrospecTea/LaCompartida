...
class EditarConfiguracionOrdenResumenProfesional extends \Database\Migration implements \Database\ITemplateMigration {
   ...
   */
	function up() {
		...
		$this->addQueryUp("UPDATE `configuracion` SET `valor_opcion` = 'fecha ASC, descripcion ASC' WHERE glosa_opcion='OrdenResumenProfesional' AND valor_opcion='trabajo.fecha ASC, trabajo.descripcion ASC'");
	}
   ...
   */
	function down() {
		...
		$this->addQueryDown("UPDATE `configuracion` SET `valor_opcion` = 'trabajo.fecha ASC, trabajo.descripcion ASC' WHERE glosa_opcion='OrdenResumenProfesional' AND valor_opcion='fecha ASC, descripcion ASC'");
	}
}
